...
| PRD 5 | [prd-cursor-integration.md](prd-cursor-integration.md) | Status bar, share-screen, Cursor mode wrapping, agent switcher | ~71% |
...
|-----|-------------|---------------------|
| PRD 1 (Voice I/O) | ADR-0001 | `design/ai/prompt-optimizer-design.md` |
| PRD 2 (Session + Persona) | ADR-0001 | `design/ux/drive-mode-user-journey.md` |
| PRD 3 (Multi-Agent) | ADR-0004, ADR-0003 | `design/architecture/cursor-native-system-design.md` |
| PRD 4 (Safety + Config) | ADR-0001 | `../reference/config-schema.md` |
| PRD 5 (Cursor Integration) | ADR-0001, ADR-0002 | `design/architecture/cursor-native-system-design.md` |

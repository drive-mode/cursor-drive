---
planId: extension-reinstall-automation
planType: task
...
todos:
  - id: discovery
    content: "Run discovery subagent: CLI commands, restart options, existing automation, extension IDs, platform differences"
    status: pending
  - id: review-report
    content: "Main agent review discovery report; decide subagent split for planning"
    status: pending
  - id: plan-cli
    content: "Planning subagent: design scripts/reinstall-extension.mjs (uninstall, compile, package, install, flags)"
    status: pending
  - id: plan-ci
    content: "Planning subagent: design CI workflow integration (reinstall flow, serve-web, smoke test)"
    status: pending
  - id: consolidate
    content: "Merge planning outputs into implementation plan; update package.json scripts and docs"
    status: pending
state: pending
isProject: false
---

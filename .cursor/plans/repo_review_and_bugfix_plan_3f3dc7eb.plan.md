...
planId: repo_review_and_bugfix_plan
overview: Perform a full-repo architecture review and produce a prioritized bug-fix implementation sequence (plan-only) with explicit verification gates before any edits. Absorbed by repo-health-and-baseline; consider archiving.
todos:
  - id: map-core-flows

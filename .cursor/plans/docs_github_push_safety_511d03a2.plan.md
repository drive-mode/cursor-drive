---
planId: docs-github-push-safety
planType: task
...
todos:
  - id: replace-personal-paths
    content: Replace C:\Users\harri\ paths with %USERPROFILE% in mcp-user-setup.md and reference/README.md
    status: completed
  - id: fix-mvp-gaps-link
    content: Fix mvp-gaps.plan.md link in cursor-drive-walkthrough.md (archive path)
    status: completed
isProject: false
---

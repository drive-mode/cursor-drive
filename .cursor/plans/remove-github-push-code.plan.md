---
planId: remove-github-push-code
planType: task
...
todos:
  - id: delete-plan-push
    content: Delete scripts/plan_push_github.sh and .cursor/commands/plan-push-github.md; update plan-issue-mapping.md
    status: pending
  - id: remove-pm-merge-job
    content: Remove cursor-docs job from .github/workflows/pm-merge.yml
    status: pending
  - id: remove-push-tool
    content: Remove push() from docs/shadow/scripts/git_commit_tool.py
    status: pending
  - id: update-refs
    content: Update plan-graph, implement.plan.md, orchestrate command, github_planning_orchestration todo
    status: pending
  - id: docs-optional
    content: "(Optional) Update pm-system.md, ADR 0021, reconciliation-plans-issues"
    status: pending
---

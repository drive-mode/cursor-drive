...
todos:
  - id: fh-01-remove-description
    content: "Remove description field from all hook entries in .cursor/hooks.json and .cursor-plugin/hooks/hooks.json"
    status: completed
  - id: fh-02-optional-py-windows
    content: "(Optional) If hooks still fail on Windows, try changing python to py in commands"
    status: pending
isProject: false
---

...
| *(new)*                            | `cursorDrive.operators.maxSubAgentsPerOperator` | Max Task-tool subagents each operator can spawn; default: 4 |
| *(new)*                            | `cursorDrive.operators.defaultPermissionPreset` | Permission preset for new operators; default: "standard"    |
| *(new)*                            | `cursorDrive.operators.namePool`                | Array of default operator names; default: Greek letters     |
...
| *(new)*                            | `cursorDrive.agentScreen.displayMode`           | "tab" / "panel" / "bottomLog"; default: "tab"               |
| *(new)*                            | `cursorDrive.agentScreen.clickBehavior`         | "openInEditor" / "openInNewWindow"; default: "openInEditor" |
| *(new)*                            | `cursorDrive.agentScreen.showPlanProgress`      | Show active plan TODOs overlay; default: true               |

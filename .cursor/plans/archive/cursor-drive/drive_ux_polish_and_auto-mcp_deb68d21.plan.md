---
planId: drive_ux_polish_and_auto-mcp_deb68d21
planType: task
...
Deep-link MCP auto-registration, audio chimes on toggle, wake-word acknowledgment (TTS + status bar), and dev-settings preset in sandbox — all implemented. Tests added for audioFeedback and pipeline wake-word paths.

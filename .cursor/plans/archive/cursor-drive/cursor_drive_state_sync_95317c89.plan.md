...
- [execute-plans SKILL](.cursor/skills/execute-plans/SKILL.md) — orchestrator command and subagent templates
...
**Residual risks:** None. All described work was already implemented; this plan verified and synced.

**Evidence:** mcpServer.ts lines 319, 431; extension.ts lines 155, 161, 192, 195, 213, 219, 240; cursor-drive.plan.md frontmatter; terminology-sas-overhaul.plan.md (archived) tso-06 status.